...
void main() async {
  ...
  try {
    ...
    String modelPath = "/Users/adel/Workspace/gguf/Huihui-gpt-oss-20b-BF16-abliterated-MXFP4_MOE.gguf";
    llama = Llama(
      modelPath,
...
You are a helpful, concise assistant. Keep your answers informative but brief.""");
    ...
    while (chatActive) {
      ...
      String prompt = chatHistory.exportFormat(ChatFormat.harmony);
