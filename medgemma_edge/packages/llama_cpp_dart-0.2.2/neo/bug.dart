...
void main() async {
  ...
  // Library path setup
  Llama.libraryPath = "/Users/adel/Workspace/llama_cpp_dart/bin/MAC_ARM64/libmtmd.dylib";
  ...
  while (chatActive) {
    ...
    String prompt = chatHistory.exportFormat(ChatFormat.gemma, leaveLastAssistantOpen: true);
